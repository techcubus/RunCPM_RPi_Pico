...
/* Definition of which CPU to use: cpu1.h, cpu2.h, cpu3.h, cpu4.h */
#define CPU "cpu1.h"

/* WiFi AT modem */
#define USE_MODEM                // Enable the WiFi modem engine (modem.h)
#define UART_BASE 0x80           // Virtual UART base I/O port address (8250-style)
                                 // Overlay files for MODEM7/MEX must use this address.
...
//
#ifdef CCP_INTERNAL
    #define CCPname "INTERNAL v3.3" // Will use the CCP from ccp.h
